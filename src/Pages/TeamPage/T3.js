...
export default function T3() {
    return (
        <div className="t3">
            ...
            <p className="t3__paragraph-2">including make-up artists, audio technicians, models, actors,</p>
            <p className="t3__paragraph-3">photographers, 2D animators, and video editors</p>
        </div>
    )
}
